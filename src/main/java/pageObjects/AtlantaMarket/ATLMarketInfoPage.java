...
public class ATLMarketInfoPage {
	...
	By atlregistrationsubmenu = By.xpath("//div[@class = 'imc-navigation__menu imc-content imc-navigation__menu--active imc-navigation__menu--fullwidth']/div[2]/div[2]/a[1]"); // Locator for Registration sub-menu
	...
	By atlmektdatespageheader = By.xpath("//span[contains(text(), 'MARKET DATES & HOURS')]"); //Locator for Market Dates & Hours page header
