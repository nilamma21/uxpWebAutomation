...
//		driver.switchTo().window(winHandleBefore);
	...
	public void TS007_ATLApp_VerifyFooterLinksTest() throws InterruptedException, IOException
	{
		...
		//Market Information
		utl.windowHandle(fl.getmarketInfo(), "Markets");
		driver.get(prop.getProperty("atlappurl"));
		Thread.sleep(3000);
		utl.scrollToBottom();
		...
		//Our Brands
		utl.windowHandle(fl.getOurBrandsATL(), "Directory");
		driver.get(prop.getProperty("atlappurl"));
		Thread.sleep(3000);
		utl.scrollToBottom();
...
//		utl.windowHandleTitle(fl.getEXPloginVerify(), "Exhibitor Portal Login");
//		driver.get(prop.getProperty("atlappurl"));
//		Thread.sleep(3000);
//		utl.scrollToBottom();
